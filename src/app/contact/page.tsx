      ...
      <div id="wrapper" className="w-full mx-auto">
        { isMenuShown &&
          ...
          <div id="franchise_message_box" className={`bg-gray-700 py-3 px-5 transition-opacity
            ${showFranchiseMessage ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"} absolute left-[70%] top-[11vh] md:top-[15.5vh] z-[-1] duration-300 rounded-lg`}>
